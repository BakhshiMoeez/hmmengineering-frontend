  ...
  return (
    <div className='aboutus-main-container'>
      ...
      <div className="about-us-hero-section-content" >
        <h1 className='about-us-hero-section-heading' style={{color:"#FEFEFA"}}>About Us</h1>
        <p className='about-us-hero-section-paragraph' style={{color:"#FEFEFA", fontSize:"1.2rem"}}>Driven by a vision of prosperity and progress, Pakistani Iron &
          Steel Mill continues to be a driving force in shaping the nation's industrial landscape. With a steadfast focus
      ...
      <div className="about-us-content-section" style={{marginTop:"2rem"}}>
        <h2>Our Company</h2>
        <p>
        ...
        <h1 style={{marginBottom:"3rem", marginTop:"2rem"}}>Largest Billet Manufacturer In Pakistan</h1>

        <h2 className='about-us-staff-heading'>
          Our Staff
        </h2>
        <div className="about-us-image-container">
          <img src={staffPics[0]} alt="chairman pic here" style={{ width: "20rem" }} />
